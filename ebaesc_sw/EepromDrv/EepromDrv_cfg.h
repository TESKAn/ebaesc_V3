...
* @date      Nov-13-2014
* 
* @brief     Configuration file for EEPROM Driver Library for 56F847xx and 
* 			 56F827xx DSC family.	   
*
******************************************************************************/ 

#ifndef EEPROMDRV_CFG_H_
#define EEPROMDRV_CFG_H_

/*****************************************************************************
 * Constants and macros 
 *****************************************************************************/

#define EEPROM_EMULATION 0

#endif /* EEPROMDRV_CFG_H_ */
