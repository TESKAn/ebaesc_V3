...
void InitSysVars(Int16 initial)
{
	...
	if(0 != initial)
	{
		...
		SYSTEM.CALIBRATION.i16PolePairArray[0] = 559;
		SYSTEM.CALIBRATION.i16PolePairArray[1] = 1032;
		SYSTEM.CALIBRATION.i16PolePairArray[2] = 1493;
		SYSTEM.CALIBRATION.i16PolePairArray[3] = 1965;
		SYSTEM.CALIBRATION.i16PolePairArray[4] = 2437;
		SYSTEM.CALIBRATION.i16PolePairArray[5] = 2906;
		SYSTEM.CALIBRATION.i16PolePairArray[6] = 3376;
		SYSTEM.CALIBRATION.i16PolePairArray[7] = 559;
