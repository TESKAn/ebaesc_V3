...
/*.*************************************************************************
*
*  File generated by Graphical Configuration Tool Fri, 07/Sep/2018, 21:46:34
*
****************************************************************************.*/
...
--------------------------------------------
    ...
    SIM - Peripheral Clock Enable: GPIO G: No , GPIO F: Yes, GPIO E: Yes, GPIO D: Yes, GPIO C: Yes, GPIO B: Yes, GPIO A: Yes, TMR A0: No 
                                   ...
                                   CMP A: Yes, CMP B: No , CMP C: No , CMP D: No , SAR ADC: No , CYC ADC: Yes, CRC: Yes, PIT0: Yes, PIT1: No , PDB0: No , PDB1: No 
...
.*/
#define QT_A1_CTRL_INIT                   0x3C80U
#define QT_A1_SCR_INIT                    0x0000U
#define QT_A1_CMP1_INIT                   0x0000U
...
.*/
#define GPIO_A_PUR_INIT                   0x0000U
...
#define GPIO_A_PUS_INIT                   0xFFFFU
...
#define GPIO_B_DDR_INIT                   0x0000U
...
--------------------------------------------
    ...
    Pin  7: Function: GPIO , Direction: Input , PullUp: Disable , Interrupt: Disable, Int.Polarity: Active high ,
.*/
#define GPIO_E_PUR_INIT                   0x0000U
#define GPIO_E_DDR_INIT                   0x0000U
...
.*/
#define GPIO_F_PUR_INIT                   0x0000U
#define GPIO_F_DDR_INIT                   0x0000U
#define GPIO_F_PER_INIT                   0x0131U
...
#define GPIO_F_PUS_INIT                   0xFFFFU
...
--------------------------------------------
    ...
    Input Clock: Bus clock/2 
    Divisor: Input clock/4 
    ...
    ADCA Input Channel: Temp sensor 
    Offset Error Correction Value: 0
.*/
#define ADC_0_ADC16_SC1A_INIT             0x0000001AU
#define ADC_0_ADC16_CFG1_INIT             0x00000055U
#define ADC_0_ADC16_CFG2_INIT             0x00000002U
#define ADC_0_ADC16_CV1_INIT              0x00000000U
#define ADC_0_ADC16_CV2_INIT              0x00000000U
#define ADC_0_ADC16_SC2_INIT              0x00000000U
...
#define ADC_1_ADLST4_INIT                 0xFECCU
...
--------------------------------------------
    ...
    Output Polarity: Inverted. Output High when Negative Input higher than Positive Input
    Positive Comparator Input Source: IN3 
    Negative Comparator Input Source: IN7 (6-bit DAC) 
    Falling Edge Interrupt: Disable
    Rising Edge Interrupt: Enable 
    Enable Pass Trough Mode: Disable
    Select hysteresis Level: 1 
    Input Filter: Input Signal Sampling [timer clocks] : 29
                  Consecutive Samples Required to Agree: 7 
                  Input Signal Latency: 2.05 us 
    Enable VREF_DAC: Enable 
    DAC Control: V1in 
    Output Level: 48
.*/
#define HSCMP_A_CR0_INIT                  0x0070U
#define HSCMP_A_CR1_INIT                  0x0059U
#define HSCMP_A_FPR_INIT                  0x001DU
#define HSCMP_A_SCR_INIT                  0x0010U
#define HSCMP_A_PCR_INIT                  0x0000U
#define HSCMP_A_DACCR_INIT                0x00B0U
#define HSCMP_A_MUXCR_INIT                0x001FU
...
#define FCAN_CTRL1_INIT                   0x033F2087U
#define FCAN_IMASK1_INIT                  0x0000FF00U
#define FCAN_RXMGMASK_INIT                0x700007AAU
#define FCAN_RX14MASK_INIT                0x700007AAU
#define FCAN_RX15MASK_INIT                0x700007AAU
